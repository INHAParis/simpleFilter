...
// Définir la touche "entrée" dans l'input (modifier l'idInput avec le bon id)
	$('#idInput').keyup(function(e){
	var code = e.key;
// Evite que la touche « entrée » fasse d'autres actions
	if(code==="Enter") e.preventDefault();
// À la pression de la touche "entrée"
	if(code==="Enter") {
